...
main() {
  ...
  echo "[INFO] Creating base instances..."
  "${SCRIPT_DIR}"/create_snapshot/create_base_instances.sh "${internal_props_file}"

  echo "[INFO] Creating snapshots..."
  "${SCRIPT_DIR}"/create_snapshot/do_snapshots.sh "${internal_props_file}"
